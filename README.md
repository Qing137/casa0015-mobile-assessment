...
| Home | Running Spots | Running Advice |
|------|--------------|----------------|
| ![Home](docs/screenshots/screen1_home.png) | ![Running Spots](docs/screenshots/screen2_running_spots.png) | ![Running Advice](docs/screenshots/screen3_advice.png) |

| Air Quality Details | Weather Forecast | Track Run | Run Log |
|--------------------|-----------------|-----------|---------|
| ![Air Quality](docs/screenshots/screen4_aqi.png) | ![Weather](docs/screenshots/screen6_weather.png) | ![Track Run](docs/screenshots/screen7_tracking.png) | ![Run Log](docs/screenshots/screen8_runlog.png) |